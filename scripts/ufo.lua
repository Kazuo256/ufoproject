...
function cmd.setup ()
  ...
  sys(false, "cd externals")
  sys(false, "git clone https://github.com/Kazuo256/luxproject.git")
  sys(false, "git clone https://github.com/Kazuo256/ufoproject.git -b infra_domain_activity")
  sys(false, "cd ..")
